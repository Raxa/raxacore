...
public class BahmniPatientDaoImplIT extends BaseIntegrationTest {
    ...
    public void shouldSearchByPatientIdentifier() {
        ...
        List<PatientResponse> patients = patientDao.getPatients("200001", "GAN", "", null, "city_village", "", 100, 0, null,"",null,addressResultFields,null, null, false);
    ...
    public void shouldSearchByPartialPatientIdentifier() {
        List<PatientResponse> patients = patientDao.getPatients("02", "GAN", "", null, "city_village", "", 100, 0, null,"",null,null,null, null, false);
        assertEquals(1, patients.size());
        PatientResponse patient = patients.get(0);
    ...
    public void shouldSearchByName() {
        ...
        List<PatientResponse> patients = patientDao.getPatients("", null, "Horatio", null, "city_village", "", 100, 0, null,"",null,null,null, null, false);
    ...
    public void shouldSearchAcrossFirstNameAndLastName() {
        List<PatientResponse> patients = patientDao.getPatients("", null, "Horati Sinha", null, "city_village", "", 100, 0, null,"",null,null,null, null, false);
    ...
    public void shouldSearchByVillage() {
        String[] addressResultFields = {"city_village"};
        List<PatientResponse> patients = patientDao.getPatients("", null, "", null, "city_village", "Ramgarh", 100, 0, null,"",null,addressResultFields,null, null, false);
        assertEquals(1, patients.size());
        PatientResponse patient = patients.get(0);
        assertEquals("341b4e41-790c-484f-b6ed-71dc8da222db", patient.getUuid());
        assertEquals("GAN200001", patient.getIdentifier());
    ...
    public void shouldSearchByNameAndVillage() {
        String[] addressResultFields = {"city_village"};
        List<PatientResponse> patients = patientDao.getPatients("", null, "Sin", null, "city_village", "Ramgarh", 100, 0, null,"",null,addressResultFields,null, null, false);
        assertEquals(1, patients.size());
        PatientResponse patient = patients.get(0);
        assertEquals("341b4e41-790c-484f-b6ed-71dc8da222db", patient.getUuid());
        assertEquals("GAN200001", patient.getIdentifier());
    ...
    public void shouldSortResultsByCreationDate() {
        List<PatientResponse> patients = patientDao.getPatients("", null, "Sinha", null, "city_village", "", 100, 0, null,"",null,null,null, null, false);
    ...
    public void shouldReturnResultAfterGivenOffset() throws Exception {
        List<PatientResponse> patients = patientDao.getPatients("", null, "Sinha", null, "city_village", "", 100, 1, null,"",null,null,null, null, false);
        assertEquals(1, patients.size());

        patients = patientDao.getPatients("", null, "Sinha", null, "city_village", "", 100, 2, null,"",null,null,null, null, false);
    ...
    public void shouldFetchBasedOnPatientAttributeTypes() throws Exception {
        ...
        List<PatientResponse> patients = patientDao.getPatients("", null, "", "testCaste1", "city_village", null, 100, 0, patientAttributes,"",null,null,patientResultFields, null, false);
    ...
    public void shouldFetchPatientsByProgramAttributes(){
        List<PatientResponse> patients = patientDao.getPatients("", null, "", "", "city_village", null, 100, 0, null,"Stage1","stage",null,null, null, false);
        assertEquals(1, patients.size());
    ...
    public void shouldFetchPatientsByAllSearchParametersExceptIdentifier(){
        ...
        List<PatientResponse> patients = patientDao.getPatients("", "", "John", "testCaste1", "city_village", "Bilaspur", 100, 0, new String[]{"caste","givenNameLocal"},"Stage1","stage",addressResultFields,patientResultFields, null, false);
        assertEquals(1, patients.size());
        PatientResponse response = patients.get(0);
        assertEquals("GAN200002",response.getIdentifier());
    ...
    public void shouldFetchPatientsByCodedConcepts(){
        ...
        List<PatientResponse> patients = patientDao.getPatients("", "", "John", "testCaste1", "city_village", "Bilaspur", 100, 0, new String[]{"caste"}, "Fac", "facility",null,null, null, false);
        assertEquals(1, patients.size());
        PatientResponse response = patients.get(0);
        assertEquals("GAN200002",response.getIdentifier());
        assertEquals("df8ae447-6745-45be-b859-403241d9913d",response.getUuid());
    ...
    public void shouldFetchPatientsByOnlyOneProgramAttribute(){
        String[] addressResultFields = {"city_village"};
        List<PatientResponse> patients = patientDao.getPatients("", null, "", null, "city_village", "", 100, 0, null,"Stage1","stage",addressResultFields,null, null, false);
        assertEquals(1, patients.size());
        PatientResponse response = patients.get(0);
        assertEquals("GAN200002",response.getIdentifier());
        assertEquals("df8ae447-6745-45be-b859-403241d9913d",response.getUuid());
    ...
    public void shouldSearchByPatientIdentifierWithAttributes() {
        List<PatientResponse> patients = patientDao.getPatients("", "", "John", null, "city_village", "", 100, 0, null,"",null,null,null, null, false);
        assertEquals(5, patients.size());
    }

    @Test
    public void shouldReturnAdmissionStatus() throws Exception{
        List<PatientResponse> patients = patientDao.getPatients("200000", "", null, null, "city_village", null, 10, 0, null, null, null,null,null, null, false);
        assertEquals(1, patients.size());
        PatientResponse patient200000 = patients.get(0);
        assertFalse(patient200000.getHasBeenAdmitted());

        patients = patientDao.getPatients("200002", "", null, null, "city_village", null, 10, 0, null, null, null,null,null, null, false);
        assertEquals(1, patients.size());
    ...
    public void shouldReturnAddressAndPatientAttributes() throws Exception{
        ...
        List<PatientResponse> patients = patientDao.getPatients("GAN200002", "", null, null, null, null, 100, 0, new String[]{"caste","givenNameLocal"},null,null,addressResultFields,patientResultFields, null, false);
        assertEquals(1, patients.size());
    ...
    public void shouldSearchPatientByNameWithSingleQuote() throws Exception {
        List<PatientResponse> patients = patientDao.getPatients(null, null, "na'me", null, null, null, 10, 0, null, null, null, null, null, null, false);
    ...
    public void shouldSearchPatientByNameWithOneSingleQuoteInSearchString() throws Exception {
        List<PatientResponse>  patients = patientDao.getPatients(null, null, "'", null, null, null, 10, 0, null, null, null, null, null, null, false);
    ...
    public void shouldGiveEmptyResultIfPatientDoesnotExistWithGivenPatientName() throws Exception {
        List<PatientResponse> patients = patientDao.getPatients(null, null, "ab'me", null, null, null, 10, 0, null, null, null, null, null, null, false);
    ...
    public void shouldGiveThePatientsIfWeSearchBySpaceSeperatedString() throws Exception {
        List<PatientResponse> patients = patientDao.getPatients(null, null, "special character", null, null, null, 10, 0, null, null, null, null, null, null, false);
    ...
    public void shouldFetchBasedOnPatientAttributeTypesWhenThereIsSingleQuoteInPatientAttribute() throws Exception {
        ...
        String[] addressResultFields = {"address3"};
        List<PatientResponse> patients = patientDao.getPatients("", null, "", "go'nd", null, null, 100, 0, patientAttributes,null,null,addressResultFields, patientResultFields, null, false);
        ...
        patients = patientDao.getPatients("", null, "", "'", null, null, 100, 0, patientAttributes,null,null,addressResultFields, patientResultFields, null, false);
    ...
    public void shouldFetchPatientsByProgramAttributesWhenThereIsSingleQuoteInProgramAttribute(){
        List<PatientResponse> patients = patientDao.getPatients("", null, "", "", null, null, 100, 0, null,"Stage'12","stage",null,null, null, false);
    ...
    public void shouldFetchPatientsByProgramAttributeWhenThereIsJustOneSingleQuoteInSearchString() throws Exception {
        List<PatientResponse> patients = patientDao.getPatients("", null, "", "", null, null, 100, 0, null,"'","stage",null,null, null, false);
    ...
    public void shouldFetchPatientsByPatientIdentifierWhenThereIsSingleQuoteInPatientIdentifier(){
        List<PatientResponse> patients = patientDao.getPatients("51'0003", "SEV", "", "", null, null, 100, 0, null,null, null,null,null, null, false);
    ...
    public void shouldFetchPatientsByPatientIdentifierWhenThereIsJustOneSingleQuoteInPatientIdentifier() throws Exception {
        List<PatientResponse> patients = patientDao.getPatients("'", "", "", "", null, null, 100, 0, null,null, null,null,null, null, false);
    ...
    public void shouldNotReturnDuplicatePatientsEvenIfThereAreMultipleVisitsForThePatients() {
        List<PatientResponse> patients = patientDao.getPatients("", null, "1058GivenName", null, "city_village", "", 100, 0, null,"",null,null,null, "8d6c993e-c2cc-11de-8d34-0010c6affd0f", false);
    ...
    public void shouldReturnPatientEvenIfThereIsNoVisitForThePatientWhenFilterByVisitLocationIsFalse() {
        List<PatientResponse> patients = patientDao.getPatients("", null, "1059NoVisit", null, "city_village", "", 100, 0, null,"",null,null,null, "8d6c993e-c2cc-11de-8d34-0010c6affd0f", false);
    ...
    public void shouldNotReturnPatientIfThereIsNoVisitForThePatientAndFilterByVisitLocationIsTrue() {
        List<PatientResponse> patients = patientDao.getPatients("", null, "1059NoVisit", null, "city_village", "", 100, 0, null,"",null,null,null, "8d6c993e-c2cc-11de-8d34-0010c6affd0f", true);
    ...
    public void shouldReturnPatientsWithinVisitLocationOfGivenLoginLocationWhenFilterByVisitLocationIsTrue() {
        List<PatientResponse> patients = patientDao.getPatients("", null, "someUnique", null, "city_village", "", 100, 0, null,"",null,null,null, "8d6c993e-c2cc-11de-8d34-0010c6affd0f", true);
        assertEquals(1, patients.size());
    ...
    public void shouldReturnAllMatchingPatientsIrrespectiveOfVisitsWhenFilterByVisitLocationIsFalse() {
        List<PatientResponse> patients = patientDao.getPatients("", null, "someUnique", null, "city_village", "", 100, 0, null,"",null,null,null, "8d6c993e-c2cc-11de-8d34-0010c6affd0f", false);
        assertEquals(2, patients.size());

        PatientResponse patient1 = patients.get(0);
        PatientResponse patient2 = patients.get(1);
        assertEquals("someUniqueOtherName", patient1.getGivenName());
        assertEquals("someUniqueName", patient2.getGivenName());
    }

    @Test
    public void shouldReturnPatientsWithinVisitLocationWhenLocationProvidedIsChildLocationAndFilterByLocationIsTrue() {
        List<PatientResponse> patients = patientDao.getPatients("", null, "someUnique", null, "city_village", "", 100, 0, null,"",null,null,null, "8d6c993e-c2cc-11de-8d13-0010c6addd0f", true);
        assertEquals(1, patients.size());
    ...
    public void shouldReturnPatientsWithinTheVisitLocationWhenTheLocationPassedIsVisitLocationAndFilterByVisitLocationIsTrue() {
        List<PatientResponse> patients = patientDao.getPatients("", null, "someUnique", null, "city_village", "", 100, 0, null,"",null,null,null, "8d6c993e-c2cc-11de-8d13-0010c6aff12f",  true);
        assertEquals(1, patients.size());
    ...
    @Test
    public void shouldReturnPatientsFromRootLocationWhenNoVisitLocationInTheHierarchyAndLocationPassedIsGrandChildLocation() {
        List<PatientResponse> patients = patientDao.getPatients("", null, "1060", null, "city_village", "", 100, 0, null,"",null,null,null, "8d6c993e-c2cc-11de-8d34-0010c6affdwe",  true);
        assertEquals(1, patients.size());

        PatientResponse patient = patients.get(0);
        assertEquals("1060NoVisitLocation", patient.getGivenName());
    }

    @Test
    public void shouldReturnPatientsFromRootLocationWhenNoVisitLocationInTheHierarchyAndLocationPassedIsChildLocation() {
        List<PatientResponse> patients = patientDao.getPatients("", null, "1060", null, "city_village", "", 100, 0, null,"",null,null,null, "8d6c993e-c2cc-11de-8d13-0010c6addd12",  true);
        assertEquals(1, patients.size());
    ...
    @Test
    public void shouldReturnPatientsFromRootLocationWhenNoVisitLocationInTheHierarchyAndLocationPassedIsRootLocation() {
        List<PatientResponse> patients = patientDao.getPatients("", null, "1060", null, "city_village", "", 100, 0, null,"",null,null,null, "8d6c993e-c2cc-11de-8d13-0010c6aff123",  true);
        assertEquals(1, patients.size());
    ...
    @Test
    public void shouldReturnPatientsWithinThePassedLocationWhenThereIsAFlatLocationHierarchy() {
        List<PatientResponse> patients = patientDao.getPatients("", null, "1061", null, "city_village", "", 100, 0, null,"",null,null,null, "8d6c993e-c2cc-11de-8d34-0010c6affdrt",   true);
        assertEquals(1, patients.size());

        PatientResponse patient = patients.get(0);
        assertEquals("1061NoLocationHierarchy", patient.getGivenName());
    }

    @Test
    public void shouldReturnAllMatchingPatientsWhenLoginLocationIsNull() {
        List<PatientResponse> patients = patientDao.getPatients("", null, "someUnique", null, "city_village", "", 100, 0, null,"",null,null,null, null, false);
        assertEquals(2, patients.size());
