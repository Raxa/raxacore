...
public interface BahmniObsService {
    ...
    public Collection<BahmniObservation> getLatest(String patientUuid, Collection<Concept> conceptNames,Integer numberOfVisits, List<String> unwantedObsConcepts, Boolean removeObsWithOrder);
    ...
    Collection<BahmniObservation> getLatestObsByVisit(Visit visit, Collection<Concept> concepts, List<String> unwantedObsConcepts, Boolean removeObsWithOrder);
}
