...
public class BahmniPatientServiceImpl implements BahmniPatientService {
    ...
    public List<PatientResponse> search(PatientSearchParameters searchParameters) {
        return bahmniPatientDao.getPatients(searchParameters.getIdentifier(), searchParameters.getName(), searchParameters.getLocalName(), searchParameters.getCityVillage(), searchParameters.getLength(), searchParameters.getStart());
    }
