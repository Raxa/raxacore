...
public class DrugMetaDataValidatorTest {
    ...
    public void ensure_drug_concept_is_not_null() {
        DrugMetaData drugMetaData = new DrugMetaData(new Drug(), null, new Concept(), new ConceptClass(), new ConceptDatatype());
    ...
    public void ensure_dosage_form_is_not_null(){
        DrugMetaData drugMetaData = new DrugMetaData(new Drug(),new Concept(), null, new ConceptClass(), new ConceptDatatype());
        DrugMetaDataValidator validator = new DrugMetaDataValidator();
        validator.validate(drugMetaData);
    }
    ...
    public void ensure_dosage_form_and_drug_concept_valid(){
        DrugMetaData drugMetaData = new DrugMetaData(new Drug(),new Concept(), new Concept(), new ConceptClass(), new ConceptDatatype());
        DrugMetaDataValidator validator = new DrugMetaDataValidator();
        validator.validate(drugMetaData);
        //No error
