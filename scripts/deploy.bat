...
REM setup
putty -ssh vagrant@%MACHINE_IP% -i "%USERPROFILE%\.vagrant.d\win_insecure_private_key.ppk" -m %SCRIPTS_DIR%/setup_environment.sh
REM Kill tomcat
putty -ssh vagrant@%MACHINE_IP% -i "%USERPROFILE%\.vagrant.d\win_insecure_private_key.ppk" -m %SCRIPTS_DIR%/tomcat_stop.sh
...
putty -ssh vagrant@%MACHINE_IP% -i "%USERPROFILE%\.vagrant.d\win_insecure_private_key.ppk" -m %SCRIPTS_DIR%/deploy_omods.sh
REM Start tomcat
putty -ssh vagrant@%MACHINE_IP% -i "%USERPROFILE%\.vagrant.d\win_insecure_private_key.ppk" -m %SCRIPTS_DIR%/tomcat_start.sh
