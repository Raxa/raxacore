...
import org.openmrs.module.bahmniemrapi.builder.TestOrderBuilder;
...
public class PartialEncounterTransactionMapperBuilderTest {
    ...
    public void shouldMapDiagnosesAndDispositionsWithoutOrders(){
        ...
        PartialEncounterTransactionMapperBuilder transactionMapperBuilder = new PartialEncounterTransactionMapperBuilder(observationsMapper,null,null,new EncounterProviderMapper());
    ...
    public void shouldMapDiagnosesAndDispositionsWithOrders(){
        ...
        EncounterObservationsMapper observationsMapper = new EncounterObservationsMapper(observationMapper, diagnosisMapper,
                dispositionMapper, emrApiProperties);
        PartialEncounterTransactionMapperBuilder transactionMapperBuilder = new PartialEncounterTransactionMapperBuilder(observationsMapper,new TestOrderMapper(),new DrugOrderMapper_1_10(),new EncounterProviderMapper());
