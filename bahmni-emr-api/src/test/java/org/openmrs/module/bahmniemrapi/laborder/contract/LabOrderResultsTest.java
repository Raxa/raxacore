...
public class LabOrderResultsTest {
    ...
    public void shouldCreateSparseMatrixForLabOrderResultAndDates() throws Exception {
        List<LabOrderResult> results = Arrays.asList(
                ...
                new LabOrderResult("uuid2", new DateTime(2014, 5, 15, 0, 0).toDate(), "ESR", "gm/L", 100.0, 200.0, "50.0", false, false, null),
                new LabOrderResult("uuid2", new DateTime(2014, 5, 16, 0, 0).toDate(), "ESR", "gm/L", 100.0, 200.0, "51.0", false, false, null),
                new LabOrderResult("uuid3", new DateTime(2014, 5, 17, 0, 0).toDate(), "ESR", null, null, null, null, null, false, null),
                new LabOrderResult("uuid3", new DateTime(2014, 5, 18, 0, 0).toDate(), "ESR", null, null, null, null, null, true, null)
        );
