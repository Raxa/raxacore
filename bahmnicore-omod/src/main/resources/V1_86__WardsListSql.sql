...
FROM bed_location_map blm
    ...
    LEFT OUTER JOIN (
        ...
        FROM bed_patient_assignment_map bpam
            ...
            INNER JOIN obs latestDisposition on maxObsId.obs_id = latestDisposition.obs_id
    ...
    LEFT OUTER JOIN (
        ...
        from bed_patient_assignment_map bpam
            ...
            INNER JOIN obs diagnosis on bpam.patient_id = diagnosis.person_id and diagnosis.encounter_id = encounter.encounter_id
