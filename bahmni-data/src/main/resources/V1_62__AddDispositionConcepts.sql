...
call add_concept_word(@concept_id, @concept_name_short_id, 'Admit', 1);
...
call add_concept_word(@concept_id, @concept_name_short_id, 'Disposition', 1);
...
call add_concept_word(@concept_id, @concept_name_short_id, 'Disposition', 1);
call add_concept_word(@concept_id, @concept_name_short_id, 'Set', 1);
