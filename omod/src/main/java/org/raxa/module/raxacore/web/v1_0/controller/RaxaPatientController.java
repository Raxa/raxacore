...
public class RaxaPatientController extends BaseRestController {
	...
	private Patient savePatient(Person person, SimpleObject post) {
		...
		createIdentifier(post, patient);
		return service.savePatient(patient);
	}
	
	private void createIdentifier(SimpleObject post, Patient patient) {
	...
	private PatientIdentifier generateIdentifier(SimpleObject post) {
