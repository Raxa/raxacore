...
if exist %KEY_FILE% (
    ...
    pscp  -i %KEY_FILE% %CWD%/../../openmrs-elis-atomfeed-client-omod/target/elisatomfeedclient-omod-%VERSION%.omod vagrant@%MACHINE_IP%:%MODULE_DEPLOYMENT_FOLDER%/elisatomfeedclient-%VERSION%.omod
