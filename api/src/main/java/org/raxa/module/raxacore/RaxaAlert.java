...
public class RaxaAlert extends BaseOpenmrsMetadata implements Serializable {
    ...
    public boolean equals(Object obj) {
        if (obj instanceof RaxaAlert) {
            ...
            if (this.getRaxaAlertId() != null && pList.getRaxaAlertId() != null) return (this.getRaxaAlertId().equals(pList.getRaxaAlertId()));
        }
        return this == obj;
    }
     ...
     */@Override
    public int hashCode() {
        if (this.getRaxaAlertId() == null) return super.hashCode();
        ...
        if (obsParent.hasGroupMembers()) {
            for (Obs child: obsParent.getGroupMembers()) {
                if (child.isVoided() == false) {
                    if (child.isObsGrouping() == false) leaves.add(child);
                    else
    ...
    public Set <Obs> getObsAtTopLevel(boolean includeVoided) {
        ...
        for (Obs o: getAllObs(includeVoided)) {
            if (o.getObsGroup() == null) ret.add(o);
        }
        return ret;
    }
